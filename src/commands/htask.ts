 ...
 * `create`, `create-feature`, `next`, `tree`, `complete`.
 * Prefer snipara-orchestrator for shared multi-agent queues; these direct calls
 * exist for scripting and diagnostics. Require a configured workspace.
 */
